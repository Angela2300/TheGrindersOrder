...
public class InventoryUI : MonoBehaviour
{
    ...
    )
    {
        for (int i = 0; i < weaponIcons.Length; i++)
        {
            ...
            switch (weapons[i])
            {
                case WeaponType.Pistol: weaponIcons[i].sprite = pistolIcon; break;
                case WeaponType.SMG: weaponIcons[i].sprite = smgIcon; break;
                case WeaponType.Shotgun: weaponIcons[i].sprite = shotgunIcon; break;
                case WeaponType.Launcher: weaponIcons[i].sprite = launcherIcon; break;
            }
        }
    }
}
